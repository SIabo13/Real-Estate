...
<section id="feature_sec">
  <div class="container pt-5 pb-5">
    <div class="row">
      ...
      <div class="col-md-7">
        <div id="properties_carousel" class="carousel slide carousel-fade" data-ride="carousel">
          ...
          <a class="carousel-control-prev" href="#properties_carousel" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
          </a>
